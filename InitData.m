...
function [input, data] = InitData(settings)
    ...
    switch settings.model
        ...
        case 'wmr'
            ...
            Q=repmat([10 10 0.01 0.01 0.01 1 1]',1,N);
            QN=[50 50 0.01 0.01 0.01]';
    ...
    %%DAVIDE: could be initialized differently (eg nominal trajectory)
